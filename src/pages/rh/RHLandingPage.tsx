...
import { Brain, Globe, Smartphone, Cog, Workflow, ArrowRight, Zap, Shield, Cpu, Users } from "lucide-react";
...
export default function RHLandingPage() {
  return (
    <RHLayout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-20">
          <motion.p
            ...
            className="text-xs tracking-[0.3em] text-cyan-400/70 uppercase mb-6"
          >
          ...
          >
            RH Software engineers intelligent systems that transform businesses through AI, web, mobile, and custom software architecture.
          </motion.p>
          <motion.div
          ...
          >
            <Link
              ...
              className="px-8 py-3.5 rounded-lg bg-cyan-400 text-black font-semibold text-sm tracking-wide hover:bg-cyan-300 hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] transition-all duration-300 hover:-translate-y-0.5"
            >
              Start Your Project
            </Link>
            <Link
              to="/rhsoftware/services"
              className="px-8 py-3.5 rounded-lg border border-white/10 text-white/80 font-medium text-sm tracking-wide hover:border-white/30 hover:bg-white/5 transition-all duration-300 hover:-translate-y-0.5"
            >
              Explore Services →
            </Link>
          </motion.div>
      ...
      {/* SCROLL MARQUEE */}
      <section className="py-12 border-y border-white/5 overflow-hidden bg-black">
      ...
      <section className="py-28 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
            <motion.p variants={fadeUp} custom={0} className="text-xs tracking-[0.3em] text-cyan-400/70 uppercase mb-3">
              What We Engineer
            </motion.p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <RHGlassCard icon={<Smartphone size={28} />} title="App Development" description="Android & cross-platform mobile applications with precision." href="/rhsoftware/services" index={2} />
            <RHGlassCard icon={<Cog size={28} />} title="Custom Software Engineering" description="Enterprise-grade business systems and internal tools." href="/rhsoftware/services" index={3} />
            <RHGlassCard icon={<Workflow size={28} />} title="Business Automation" description="Workflow automation, CRM systems, and intelligent process optimization." href="/rhsoftware/services" index={4} />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Founders", "Startups", "Developers", "Enterprises"].map((item, i) => (
              <motion.span
                ...
                className="px-6 py-3 rounded-full border border-white/10 text-white/60 text-sm tracking-wide bg-white/[0.02]"
              >
                {item}
              </motion.span>
            ))}
      ...
      <section className="py-28 bg-black">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-center p-12 md:p-16 rounded-3xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm"
          >
            <h2 className="text-2xl md:text-4xl font-black text-white tracking-tight mb-4">
              Start Building Intelligent Systems Today.
            </h2>
            <p className="text-white/40 mb-8">Let's engineer something extraordinary together.</p>
            <Link
              to="/rhsoftware/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-cyan-400 text-black font-semibold text-sm tracking-wide hover:bg-cyan-300 hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] transition-all duration-300"
            >
